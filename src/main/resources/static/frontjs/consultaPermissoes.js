...
window.onload = function () {
    ...
    var table = $('tabelaPermissoes').Database;
...
function renderPermissoes()
{
    ...
    for(var i = 0; i < retorno.length; i++){
        ...
        document.getElementById("tbodyPermissoes").appendChild(tr);
    }
